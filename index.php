            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 wow fadeIn" data-wow-delay="0.9s">
                        ...
                        <h1>Pratik</h1>
                        <h2 class="rotate">Designer &AMP; Developer, UI &AMP; UX Designer, Digital Marketer</h2>
                        <p>I am computer science engineer and passinate to develop software.</p>
                    ...
                    <div class="col-md-4 col-xs-11 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Responsive Webpages</h3>
                                <p>Design and develop responsive websites.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-11 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Optimize and rank website in searching</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-11 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Design UI &AMP; UX wireframe using <a rel="nofollow" href="https://balsamiq.com">Balsamiq</a> and <a rel="nofollow" href="http://Figma.com">Figma</a>.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-xs-11 wow fadeInLeft" data-wow-delay="0.9s">
                        ...
                        <p>I am Pratik Kumar from Bihar.I am 20 year old. I am pursuing my Bachelor degree from Galgotias University. I have completed my senior secondary from Rajdhani Public School.</p>
                        <p>My hobbies are Playing outdoor games and love travelling in different places. </p>
                    </div>
                    <div class="col-md-6 col-xs-11 wow fadeInRight" data-wow-delay="0.9s">
                        ...
                        <span>Mobile Apps <small>60%</small></span>
                        <div class="progress">
                ...
                <div class="row">
                    <div class="col-lg-5 col-lg-offset-1 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <address>
                            ...
                            <p><i class="fa fa-phone"></i>+91 9304642794</p>
                            <p><i class="fa fa-envelope-o"></i> pratikkuma2808@gmail.com</p>
                            <p><i class="fa fa-map-marker"></i> Chimnapur, Lalganj Dist- Vaishali, Bihar-844121</p>
                        </address>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 wow fadeIn" data-wow-delay="0.7s">
                        <p>Copyright &copy; Pratik Personal Profile

                            . Designed by Pratik Kumar</p>
                        <hr>
